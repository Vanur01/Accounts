...
const PurchaseOrderForm: React.FC<PurchaseOrderFormProps> = ({
  ...
  const handleFormSubmit = () => {
    ...
    if (!purchaseOrderNo.trim()) newErrors.purchaseOrderNo = "Purchase Order No is required";
  ...
  return (
    <div className="max-w-7xl mx-auto py-8 px-2 md:px-8 bg-gradient-to-br from-gray-50 to-white min-h-screen">
      ...
      <div className="mb-2">
        {errors.purchaseOrderNo && <div className="text-red-500 text-xs">{errors.purchaseOrderNo}</div>}
